...
var file_accord_proto_rawDesc = []byte{
	...
	0x72, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xdf, 0x01, 0x0a, 0x04, 0x43,
	0x68, 0x61, 0x74, 0x12, 0x4e, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x1c, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x43, 0x72, 0x65, 0x61,
...
var file_accord_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_accord_proto_goTypes = []interface{}{
	...
	(*Channel)(nil),                      // 2: Accord.Channel
	(*CreateChannelRequest)(nil),         // 3: Accord.CreateChannelRequest
	(*CreateChannelResponse)(nil),        // 4: Accord.CreateChannelResponse
	(*GetChannelsRequest)(nil),           // 5: Accord.GetChannelsRequest
	(*GetChannelsResponse)(nil),          // 6: Accord.GetChannelsResponse
	(*StreamRequest)(nil),                // 7: Accord.StreamRequest
	(*StreamResponse)(nil),               // 8: Accord.StreamResponse
	(*StreamRequest_UserMessage)(nil),    // 9: Accord.StreamRequest.UserMessage
	(*StreamRequest_ConfMessage)(nil),    // 10: Accord.StreamRequest.ConfMessage
	(*StreamResponse_NewMessage)(nil),    // 11: Accord.StreamResponse.NewMessage
	(*StreamResponse_UpdateMessage)(nil), // 12: Accord.StreamResponse.UpdateMessage
	(*timestamp.Timestamp)(nil),          // 13: google.protobuf.Timestamp
}
var file_accord_proto_depIdxs = []int32{
	2,  // 0: Accord.GetChannelsResponse.channels:type_name -> Accord.Channel
	9,  // 1: Accord.StreamRequest.user_msg:type_name -> Accord.StreamRequest.UserMessage
	10, // 2: Accord.StreamRequest.conf_msg:type_name -> Accord.StreamRequest.ConfMessage
	13, // 3: Accord.StreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	11, // 4: Accord.StreamResponse.new_msg:type_name -> Accord.StreamResponse.NewMessage
	12, // 5: Accord.StreamResponse.update_msg:type_name -> Accord.StreamResponse.UpdateMessage
	...
	3,  // 8: Accord.Chat.CreateChannel:input_type -> Accord.CreateChannelRequest
	5,  // 9: Accord.Chat.GetChannels:input_type -> Accord.GetChannelsRequest
	7,  // 10: Accord.Chat.Stream:input_type -> Accord.StreamRequest
	4,  // 11: Accord.Chat.CreateChannel:output_type -> Accord.CreateChannelResponse
	6,  // 12: Accord.Chat.GetChannels:output_type -> Accord.GetChannelsResponse
	8,  // 13: Accord.Chat.Stream:output_type -> Accord.StreamResponse
